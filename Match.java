...
class Match {
    ...
    public Match() {
        ...
        _lib[3] = _pf.getToolkit().getImage("HardBrick.gif");
        _lib[4] = _pf.getToolkit().getImage("PowerBrick.gif");
        _lib[5] = _pf.getToolkit().getImage("WallBrick.gif");
        _lib[6] = _pf.getToolkit().getImage("StickyBrick.gif");
        _lib[7] = _pf.getToolkit().getImage("ArmorBrick.gif");
        _lib[8] = _pf.getToolkit().getImage("TrapBrick.gif");
    ...
    public void start() {
        ...
        _bp = new BrickPile(_pf, _lib[2], _lib[3], _lib[4], _lib[5], _lib[6], _lib[7], _lib[8]);
